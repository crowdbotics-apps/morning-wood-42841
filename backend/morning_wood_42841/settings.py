"""
Django settings for morning_wood_42841 project.
...
ROOT_URLCONF = 'morning_wood_42841.urls'
...
WSGI_APPLICATION = 'morning_wood_42841.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_wood_42841 API",
    "DESCRIPTION": "API documentation for morning_wood_42841 App",
    "VERSION": "v1",
}
